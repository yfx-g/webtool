...
;(function emojiCursor() {
  ...
  function bindEvents() {
    document.addEventListener('mousemove', debounce(15, onMouseMove))
    document.addEventListener('touchmove', debounce(15, onTouchMove))
    document.addEventListener('touchstart', debounce(15, onTouchMove))
